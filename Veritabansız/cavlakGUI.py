    ...
    def retranslateUi(self, MainWindow):
        ...
        def tablo():
            ...
            for i in range(0,len(dosyaUzun.readlines())):
                ...
                item = QtWidgets.QTableWidgetItem(dosya.readlines()[i])#Eğer 4'ün katı olmayan bir sıradaysa dosyayı okur(2,3,5. sutunlarda stok_bilgi.txt'deki verileri yazar.
               
                if(i % 4 == 0):#eğer 1. 4. 8. vs sutunlardaysa (satırın ilk sutunu bunlardır)
                    item = QtWidgets.QTableWidgetItem(str(sira)) # 1,2,3,4,5...n sayılarını girer.
                    sira = sira + 1
        ...
        def urunAra():
            ...
            for i in range(0,len(urunListe)): 
                ...
                if(urunListe[i].strip() == str(urunStokKod)):
                    ...
                    self.tableWidget.setItem(0, 3, QtWidgets.QTableWidgetItem(urunListe[i + 1]))   
...
class Backend():
	...
	def veriTabani(self): #yenileye basınca calışır vaziyette
